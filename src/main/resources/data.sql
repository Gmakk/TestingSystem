...
INSERT INTO requirement VALUES (2,'Нужно протестировать отображение','Test project');
INSERT INTO requirement VALUES (3,'Нужно протестировать авторизацию','Test project');
